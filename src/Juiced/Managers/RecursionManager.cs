...
namespace Juiced
{
    ...
    {
        private static readonly ConcurrentDictionary<Guid, ConcurrentStack<Type>> _stacks = new ConcurrentDictionary<Guid, ConcurrentStack<Type>>();
        ...
        private static ConcurrentStack<Type> GetStack(Guid identifier)
        {
            ...
            if (stack == null)
            {
                throw new JuicedException($"No stack found for key {identifier}.");
            }
